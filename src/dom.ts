...
export const setValue = (element: Element, value: string): Result<undefined, undefined> => {
...
export const setStyleProperty = (element: Element, propertyName: string, value: string): boolean => {
...
export const getAttribute = (element: Element, attr: string): Option<string> => {
  return toOption(element.getAttribute(attr));
}
export const setAttribute = (element: Element, attr: string, value: string): void => {
